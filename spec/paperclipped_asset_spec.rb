...
describe PaperclippedAsset do
# before(:each) do
#   @asset = PaperclippedAsset.new
#   @uploaded_image = uploaded_jpeg("#{RAILS_ROOT}/vendor/plugins/paperclipped_assets/spec/fixtures/assets/rails.png")
#   @uploaded_text = uploaded_txt("#{RAILS_ROOT}/vendor/plugins/paperclipped_assets/spec/fixtures/assets/sample.txt")
# end
# 
...
#   lambda do
#     @asset = create_asset(:data => @uploaded_image)
#     @essay = MockClient.create(:title => 'foo')
